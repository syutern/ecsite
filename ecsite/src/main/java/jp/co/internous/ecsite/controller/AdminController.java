...
import jp.co.internous.ecsite.model.form.LoginForm;
...
public class AdminController {
	...
	@PostMapping("/welcome")
	public String welcome(LoginForm form, Model m) {
	...
	public String goodsMst(LoginForm form, Model m) {
	...
	public String addGoods(GoodsForm goodsForm, LoginForm loginForm, Model m) {
